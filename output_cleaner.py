"""Output cleaner — strips think blocks, code fences, role prefixes, JSON wrappers, planning language.

Direct port of reference/ComfyUI-QwenVL-Mod/AILab_OutputCleaner.py (158 lines, pure regex).
"""
